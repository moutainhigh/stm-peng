...
public class IPUtil {
	public static void main(String[] args) {
		...
		Nets nets = getEndIP("10.229.0.110", 24);
		System.out.println(nets.getStartIP() + "-" + nets.getEndIP() + ":"
				+ nets.getNetMask());
	}
	...
	public static String inetNtoa(String ip) {
		return inetNtoa(Long.parseLong(ip));
	}
