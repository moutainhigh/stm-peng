...
public final class CapcityErrorCodeConstant implements java.io.Serializable{
	...
	/**
	 * Oracle SID或Service Name输入错误
	 */
	public static final int ERR_CAPCITY_ORACLE_SID_OR_SERVICENAME = 828;
	
	/**
	 * jmx连接建立失败
	 */
	public static final int ERR_CAPCITY_JMX_CONN = 829;
	/**
	 * URL错误
	 */
	public static final int ERR_CAPCITY_URL_ERR = 830;
	
	/**
	 * JMX端口错误
	 */
	public static final int ERR_CAPCITY_JMX_PORT = 831;
