...
File name:		ApplicationXmlToXml.h
Description:	将3.5中application应用的配置文件转换为4.0中的配置文件或者标准的excel文件
Function List:
...
class ApplicationXmlToXml : public BaseConver
{
public:
	...
	** 返回值： 无
	*/
	ApplicationXmlToXml(string xmlpath, string filename, string kpifilename, string outfilepath, int flag = 1);
	~ApplicationXmlToXml(void);
