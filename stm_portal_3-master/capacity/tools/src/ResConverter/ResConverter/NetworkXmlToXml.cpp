...
{
	//先解析public，如果本身自己中也有同一个指标，直接放弃，不解析
...
void NetworkXmlToXml::ParseFile(string pathfilename)
{
		...
		devicetypeinfo = devicetypeinfo->next_sibling())
	{
		...
		**********************************************************************/
		...
		/********************************************************************
		解析devicetypeinfo节点的子节点devicetypes->devicetype->sysoid
		**********************************************************************/
