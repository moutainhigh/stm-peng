...
public class ResinCollector {
	private static final String OBJECTNAME_TYPE_SERVER = "resin:type=ResinServer";
	...
	public String getHomeDir() {
		try {
			ObjectName objName = new ObjectName(OBJECTNAME_TYPE_SERVER);
	...
	public String getThreadPoolOverView() {
		try {
			...
			Map<String, String> attrs = ResinJmxUtil.getAttributes(getJMXConnector().getMBeanServerConnection(), name, "ThreadMax", "ActiveThreadCount");
			List<Map<String, String>> list = new ArrayList<Map<String,String>>();
			list.add(attrs);
			return ResinJmxUtil.attrMapsToString(list, new String[]{"ThreadMax", "ActiveThreadCount"});
		} catch (Exception e) {
	...
	public String getJdbcConnDetail() {
		try {
			...
			List<Map<String, String>> list = new ArrayList<Map<String,String>>();
			for(ObjectName name : instances) {
				Map<String, String> attrs = ResinJmxUtil.getAttributes(getJMXConnector().getMBeanServerConnection(), name, ATTRIBUTE_NAME, "IdleConnectionCount", "ActiveConnectionCount", "MaxConnections");
				attrs.put("Availability", "1");
				list.add(attrs);
			}
			return ResinJmxUtil.attrMapsToString(list, new String[]{"Name", "Availability", "IdleConnectionCount", "ActiveConnectionCount", "MaxConnections"});
		} catch (Exception e) {
	...
	public String getWebAppDetail() {
		try {
			...
			List<Map<String, String>> list = new ArrayList<Map<String,String>>();
			for(ObjectName name : instances) {
				Map<String, String> attrs = ResinJmxUtil.getAttributes(getJMXConnector().getMBeanServerConnection(), name, "ContextPath","ActiveSessionCount");
			...
			return ResinJmxUtil.attrMapsToString(list, new String[]{"AppId", "ContextPath", "Availability","ActiveSessionCount"});
		} catch (Exception e) {
