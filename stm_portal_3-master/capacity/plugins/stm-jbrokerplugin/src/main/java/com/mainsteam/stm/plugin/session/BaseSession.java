package com.mainsteam.stm.plugin.session;
 ...
 *
 */
public class BaseSession implements PluginSession {
	
	private static final String PORT = "Port";
	private static final String IP = "IP";
	private static final String COMMAND = "COMMAND";
	private static final Log logger = LogFactory.getLog(BaseSession.class);
	//两个参数
