...
public class Response {
	...
	public static final int ERR_CODE_EMPTY = 0x10;
	public static final int ERR_CODE_WRITEIO = 0x11;
	public static final int ERR_CODE_READIO = 0x11;
	
	/**
	 * 源端发送给本程序的查询命令，本程序原样返回
	 */
	private Request wmi_query_req;
	...
	public Request getWmi_query_req() {
		return wmi_query_req;
	}

	public void setWmi_query_req(Request wmi_query_req) {
