...
public class AlarmEventQueryDetail {
	...
	private String ext8;
	private String ext9;
	private List<HandleType> handleTypes;
	...
	public List<HandleType> getHandleTypes() {
		return handleTypes;
	}
	public void setHandleTypes(List<HandleType> handleTypes) {
