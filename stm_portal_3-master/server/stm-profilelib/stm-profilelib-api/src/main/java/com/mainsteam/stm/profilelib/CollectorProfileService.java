 ...
 *          <br>
 */
public interface CollectorProfileService {
	 ...
	 * @return 策略基础信息
	 */
	List<Profile> getParentProfileByType(ProfileTypeEnum profileType)
			throws ProfilelibException;
	 ...
	 * @return 策略信息
	 */
	List<Profile> getAllParentProfile() throws ProfilelibException;
	 ...
	 * @throws ProfilelibException
	 */
	Profile getProfileByResourceId(String resourceId) throws ProfilelibException;
...
//	 *            资源实例id列表
//	 * @return Map<Long,Profile> key:resourceInstanceId
//	 */
//	Map<Long, Profile> getBasicInfoByResourceInstanceIds(
//			List<Long> resourceInstanceIds) throws ProfilelibException;
	 ...
	 * @return
	 */
	Profile getPersonalizeProfileByResourceInstanceId(long resourceInstanceId) throws ProfilelibException;
	/**
	 * 取策略绑定实例信息
	 * @param profileId 策略Id
	 ...
	 * @return 策略信息
	 */
	Profile getProfileByResourceInstanceId(long resourceInstanceId) throws ProfilelibException;
