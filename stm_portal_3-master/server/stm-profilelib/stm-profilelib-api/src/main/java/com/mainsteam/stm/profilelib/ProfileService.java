...
public interface ProfileService {
	 ...
	 * @throws ProfilelibException
	 */
	long addMonitorUseDefaultForTopo(long parentInstanceId) throws ProfilelibException;
	 ...
	 * @throws ProfilelibException
	 */
	Map<Long, Long> addMonitorUseDefaultForTopo(List<Long> parentInstanceIds) throws ProfilelibException;
	...
	/**
	 * 开启子实例监控 ，如果子实例不可用，不加入到监控
	 * @param childInstanceIds 子实例Id
	 */
	void autoRefreshChildEnableMonitor(long parentId,List<Long> childInstanceIds) throws ProfilelibException;
	
	/**
	 * 开启子实例监控
	 * @param childInstanceIds 子实例Id
	 */
	void enableChildMonitorByParentInstanceId(long parentId,List<Long> childInstanceIds) throws ProfilelibException;
	/**
	 * 开启监控 
	 * 1：父与子实例一起监控
	 * 2：查找改设备上一次策略。如果没有，使用默认策略
	 * @param parentInstanceIds 父实例Id
	 */
	void enableMonitorForTopo(List<Long> parentInstanceIds) throws ProfilelibException;
	 ...
	 * @return
	 */
	List<ProfileMetric> getProfileMetricsByResourceInstanceId(long resourceInstanceId) throws ProfilelibException;
	
	/**
	 * TODO 用于页面显示
	 * 通过实例id和指标id获取指定的ProfileMetrice
	 * @param resourceInstanceId
	 * @param metricId
	 * @return
	 * @throws ProfilelibException
	...
	ProfileMetric getProfileMetricByInstanceIdAndMetricId(long resourceInstanceId, String metricId) throws ProfilelibException;
	/**
	 * 根据策略ID获取当前策略<br/>
	 ...
	 * @throws ProfilelibException
	 */
	Profile getProfilesById(long profileId,int nodeGroupId) throws ProfilelibException;
