...
/**
 * <li>文件名称: IIpGroupProtoApiImpl.java</li> <li>公　　司: 武汉美新翔盛科技有限公司</li> <li>
 ...
 * @author lil
 */
public class IIpGroupProtoApiImpl implements IIpGroupProtoApi {

	private IIpGroupProtoDao ipGroupProtoDao;

	/**
	 * @return the ipGroupProtoDao
	 */
	public IIpGroupProtoDao getIpGroupProtoDao() {
		return ipGroupProtoDao;
	}

	/**
	 * @param ipGroupProtoDao
	 *            the ipGroupProtoDao to set
	 */
	public void setIpGroupProtoDao(IIpGroupProtoDao ipGroupProtoDao) {
		this.ipGroupProtoDao = ipGroupProtoDao;
	}

	@Override
	public NetflowPageBo ipGroupProtoPageSelect(NetflowParamBo bo) {
		...
		// 获取某一设备的应用总流量
		Whole whole = ipGroupProtoDao.getTotalIpGroupProtoNetflows(bo);
		...
		// 执行流量查询
		ipGroupProtoDao.ipGroupProtoPageSelect(page);
	...
	@Override
	public NetflowCharWrapper getIpGroupProtoChartData(NetflowParamBo bo) {
		...
		if (null != datas && !datas.isEmpty()) {
			for (NetflowBo e : datas) {
				...
				List<NetflowBo> bos = ipGroupProtoDao
						.getIpGroupProtoChartData(bo);
