...
/**
 * <li>文件名称: ExcelUtil</li> <li>公　　司: 勤智数码科技股份有限公司</li> <li>版权所有:
 * 版权所有(C)2014-2020</li> <li>修改记录: ...</li> <li>内容摘要: ...</li> <li>其他说明: ...</li>
 * 
 * @version oc4.x
 * @since 2014年10月23日 下午5:45:03
 * @author 俊峰
 */
...
public class ExcelUtil<T> {
	...
	public void exportExcel(String title, List<ExcelHeader> headers,
		...
		// 声明一个工作薄
		Workbook workbook = new HSSFWorkbook();//在内存中只存10000条数据，防止内存溢出，其他数据写入硬盘
		// 生成一个样式
