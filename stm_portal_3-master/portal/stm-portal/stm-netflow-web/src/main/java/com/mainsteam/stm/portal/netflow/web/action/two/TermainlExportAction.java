...
public class TermainlExportAction {

	@RequestMapping("termainl")
	public void termainl(HttpServletResponse resp, String type)
		...
		TerminalPageBo appBo = (TerminalPageBo) session
				.getAttribute(ExportAction.TERMINAL_TABLE_THREE);
		pdf.addCircular("应用环形图(" + NetFlowUtil.getSortName(appBo.getSort())
				+ ")", new CircularAdapter().adapter("app_name",
				StringUtil.isNull(appBo.getSort()) ? appBo.getTcBo().getSort()
		...
		TerminalChartDataBo sessionChart = (TerminalChartDataBo) session
				.getAttribute(ExportAction.SESSION_CHART_THREE);
		pdf.addLine(
		...
		TerminalPageBo sessionBo = (TerminalPageBo) session
				.getAttribute(ExportAction.SESSION_TABLE_THREE);
		...
		TerminalChartDataBo tosChart = (TerminalChartDataBo) session
				.getAttribute(ExportAction.TOS_CHART_THREE);
		pdf.addLine(
		...
		TerminalPageBo tosBo = (TerminalPageBo) session
				.getAttribute(ExportAction.TOS_TABLE_THREE);
		...
		TerminalChartDataBo protocolChart = (TerminalChartDataBo) session
				.getAttribute(ExportAction.PROTOCOL_CHART_THREE);
		pdf.addLine(
				"协议折线图("
		...
		TerminalPageBo protocolBo = (TerminalPageBo) session
				.getAttribute(ExportAction.PROTOCOL_TABLE_THREE);
