...
public class SessionExportAction {

	public static final String SESSION_PROTOCOL_TABLE_THREE = "SESSION_PROTOCOL_TABLE_THREE";
	public static final String SESSION_APP_TABLE_THREE = "SESSION_APP_TABLE_THREE";

	@RequestMapping("session")
	public void next(HttpServletResponse resp, String type) throws IOException,
			NoSuchMethodException, SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		HttpSession session = BaseAction.getHttpServletRequest().getSession();
		PDFHelper pdf = new PDFHelper("协议流量");
		// 协议
		SessionPageBo protocolBo = (SessionPageBo) session
				.getAttribute(SESSION_PROTOCOL_TABLE_THREE);
		pdf.addCircular(
		...
		SessionPageBo appBo = (SessionPageBo) session
				.getAttribute(SESSION_APP_TABLE_THREE);
