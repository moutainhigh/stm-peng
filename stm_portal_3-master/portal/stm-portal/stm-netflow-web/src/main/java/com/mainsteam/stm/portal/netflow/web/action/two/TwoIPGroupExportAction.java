...
public class TwoIPGroupExportAction {
	...
	public void ipGroup(HttpServletResponse resp, String type)
		...
		NetflowCharWrapper appChart = (NetflowCharWrapper) session
				.getAttribute(IPGroupExportAction.IP_GROUP_APP_CHART_THREE);
		pdf.addLine(
		...
		NetflowPageBo sessionBo = (NetflowPageBo) session
				.getAttribute(IPGroupExportAction.IP_GROUP_SESSION_TABLE_THREE);
		...
		NetflowPageBo terminalBo = (NetflowPageBo) session
				.getAttribute(IPGroupExportAction.IP_GROUP_TERMINAL_TABLE_THREE);
		pdf.addCircular(
				"终端环形图("
		...
		NetflowPageBo protocolBo = (NetflowPageBo) session
				.getAttribute(IPGroupExportAction.IP_GROUP_PROTOCOL_TABLE_THREE);
		pdf.addCircular(
				"协议环形图("
		...
		NetflowCharWrapper tosChart = (NetflowCharWrapper) session
				.getAttribute(IPGroupExportAction.IP_GROUP_TOS_CHART_THREE);
		pdf.addLine(
		...
		NetflowPageBo tosBo = (NetflowPageBo) session
				.getAttribute(IPGroupExportAction.IP_GROUP_TOS_TABLE_THREE);
