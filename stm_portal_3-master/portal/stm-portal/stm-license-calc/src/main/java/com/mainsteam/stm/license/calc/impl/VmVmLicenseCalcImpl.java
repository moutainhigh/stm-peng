...
@Service("vmVmLicenseCalc")
public class VmVmLicenseCalcImpl extends ILicenseCalcApi {
	
	private Logger logger = Logger.getLogger(VmVmLicenseCalcImpl.class);
	...
	public String getType() {
		return LicenseModelEnum.stmMonitorVmVm.toString();
	}
	...
	public String getDesc() {
		return LicenseModelEnum.stmMonitorVmVm.getCode();
	}
