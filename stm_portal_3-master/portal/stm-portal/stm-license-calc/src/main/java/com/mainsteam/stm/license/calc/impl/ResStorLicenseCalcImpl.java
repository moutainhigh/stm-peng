...
@Service("resStorLicenseCalc")
public class ResStorLicenseCalcImpl extends ILicenseCalcApi{
	
	private Logger logger = Logger.getLogger(ResStorLicenseCalcImpl.class);
	...
	public String getType() {
		return LicenseModelEnum.stmMonitorStor.toString();
	}
	...
	public int getUsed() {
		...
		try {
			...
			used = -1;
			logger.error("ResStorLicenseCalcImpl getUsed method:", e);
		}
		return used;
	}
	...
	public String getDesc() {
		return LicenseModelEnum.stmMonitorStor.getCode();
	}
