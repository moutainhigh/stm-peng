...
@Service("resRdLicenseCalc")
public class ResRdLicenseCalcImpl extends ILicenseCalcApi {

	private Logger logger = Logger.getLogger(ResRdLicenseCalcImpl.class);
	...
	public String getType() {
		return LicenseModelEnum.stmMonitorSh.toString();//stmMonitorRd
	}
	...
	public int getUsed() {
		...
		try {
			...
			used = -1;
			logger.error("ResRdLicenseCalcImpl getUsed method:", e);
		}
		return used;
	}
	...
	public String getDesc() {
		return LicenseModelEnum.stmMonitorSh.getCode();//stmMonitorRd
	}
