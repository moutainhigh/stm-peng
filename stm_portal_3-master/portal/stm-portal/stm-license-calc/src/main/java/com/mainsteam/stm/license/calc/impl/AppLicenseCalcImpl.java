...
@Service("appLicenseCalc")
public class AppLicenseCalcImpl extends ILicenseCalcApi {
	
	private Logger logger = Logger.getLogger(AppLicenseCalcImpl.class);
	...
	public String getType() {
		return LicenseModelEnum.stmMonitorApp.toString();
	}
	...
	public String getDesc() {
		return LicenseModelEnum.stmMonitorApp.getCode();
	}
}
