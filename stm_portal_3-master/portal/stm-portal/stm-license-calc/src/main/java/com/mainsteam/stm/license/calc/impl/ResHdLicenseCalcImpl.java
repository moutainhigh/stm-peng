...
@Service("resHdLicenseCalc")
public class ResHdLicenseCalcImpl extends ILicenseCalcApi {
	
	private Logger logger = Logger.getLogger(ResHdLicenseCalcImpl.class);
	...
	public String getDesc() {
		return LicenseModelEnum.stmMonitorSh.getCode();//stmMonitorHd
	}
}
