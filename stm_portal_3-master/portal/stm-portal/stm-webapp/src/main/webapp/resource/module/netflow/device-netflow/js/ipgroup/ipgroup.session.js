...
//	var type = getType();
	 ...
	 * 初始化datagrid
	 */
	var datagridDiv=$('.ipgroup-session-datagrid');
	datagridObj_netflow_ipgroup_session=oc.ui.datagrid({
...
//    				var ti = timePerid;
    				...
    				genNetflowChart($('.ipgroup-session-hc'), 660, 135, data.data.timeLine, data.data.bos, data.data.sortColumn, data.data.yAxisName, step, ti, st, et);
    			}
    		});
	     }
	});
