...
//	var type = getType();
	...
	var tarDiv = $('.terminal-session-datagrid');
	datagridObj_netflow_terminal_session = oc.ui.datagrid({
		selector: tarDiv,
		pagination: false,
		sortOrder : 'desc',
		queryParams :{
	    	 ...
	    	 var param =data.tcBo;
	    		oc.util.ajax({
	    			...
	    			success:function(data){ 
	    				...
	    				genNetflowChart($('.terminal-session-hc'), 660, 135, timepoint, terminals, unit, yname, step, ti, st, et);
