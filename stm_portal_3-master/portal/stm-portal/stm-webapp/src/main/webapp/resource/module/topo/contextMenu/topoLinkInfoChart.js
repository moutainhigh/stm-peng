/**
 * TopoLinkInfoChart 图表类
 * Created by huangping on 2017/6/27.
 */
function TopoLinkInfoChart(div, divWidthParameter, childrenResourceType) {
    this.id = div.attr('id');
    this.divObj = div;
    ...
    this.metricGroupSource = [[/*{metricId : 'ifBandWidthUtil',name : '带宽利用率',color : '#2894FF'},*/
        {metricId: 'ifInBandWidthUtil', name: '下行带宽利用率', color: '#f96e03'},
        {metricId: 'ifOutBandWidthUtil', name: '上行带宽利用率', color: '#55BF3B'}],
        [{metricId: 'ifInOctetsSpeed', name: '下行速率', color: '#2894FF'},
            {metricId: 'ifOutOctetsSpeed', name: '上行速率', color: '#f96e03'}
//	                    ,{metricId : 'ifOctetsSpeed',name : '接口总流量',color : 'linegreen'}
        ]];

}

TopoLinkInfoChart.prototype = {
    id: undefined,
    inerId: undefined,
    divObj: undefined,
                    ...
                    areaStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                ...
                                offset: 0.8,
                                color: 'rgba(0, 136, 212, 0.3)' // 100% 处的颜色
                            }], false),
            ...
            tooltip: {
                ...
                formatter: function (params) {
                    ...
                    if (params[1].data == undefined && params[2].data == undefined) {
                        var dateTool = new Date(params[0].data[0]);
                        return params[0].seriesName + "<br/>" + (dateTool.getDate()) + '/' + (dateTool.getHours()) + ':' + (dateTool.getMinutes() < 10 ? '0' + dateTool.getMinutes() : dateTool.getMinutes()) + ' : ' + unitTransform(params[0].data[1], dataObj.unit)
                    }
                    if (params[0].data == undefined && params[2].data == undefined) {
                        var dateTool1 = new Date(params[1].data[0]);
                        return params[1].seriesName + "<br/>" + (dateTool.getDate1()) + '/' + (dateTool1.getHours()) + ':' + (dateTool1.getMinutes() < 10 ? '0' + dateTool1.getMinutes() : dateTool1.getMinutes()) + ' : ' + unitTransform(params[1].data[1], dataObj.unit)
                    }
                    if (params[0].data == undefined && params[1].data == undefined) {
                        var dateTool2 = new Date(params[2].data[0]);
                        return params[2].seriesName + "<br/>" + (dateTool.getDate2()) + '/' + (dateTool2.getHours()) + ':' + (dateTool2.getMinutes() < 10 ? '0' + dateTool2.getMinutes() : dateTool2.getMinutes()) + ' : ' + unitTransform(params[2].data[1], dataObj.unit)
                    }
                    if (params[1].data == undefined) {
                        var dateTool = new Date(params[0].data[0]);
                        var dateTool2 = new Date(params[2].data[0]);
                        return params[0].seriesName + "<br/>" + (dateTool.getDate()) + '/' + (dateTool.getHours()) + ':' + (dateTool.getMinutes() < 10 ? '0' + dateTool.getMinutes() : dateTool.getMinutes()) + ' : ' + unitTransform(params[0].data[1], dataObj.unit) + '<br/>'
                            + params[2].seriesName + "<br/>" + (dateTool2.getDate()) + '/' + (dateTool2.getHours()) + ':' + (dateTool2.getMinutes() < 10 ? '0' + dateTool2.getMinutes() : dateTool2.getMinutes()) + ' : ' + unitTransform(params[2].data[1], dataObj.unit)
                    }
                    if (params[0].data == undefined) {
                        var dateTool1 = new Date(params[1].data[0]);
                        var dateTool2 = new Date(params[2].data[0]);
                        return params[1].seriesName + "<br/>" + (dateTool.getDate1()) + '/' + (dateTool1.getHours()) + ':' + (dateTool1.getMinutes() < 10 ? '0' + dateTool1.getMinutes() : dateTool1.getMinutes()) + ' : ' + unitTransform(params[1].data[1], dataObj.unit) + '<br/>'
                            + params[2].seriesName + "<br/>" + (dateTool.getDate2()) + '/' + (dateTool2.getHours()) + ':' + (dateTool2.getMinutes() < 10 ? '0' + dateTool2.getMinutes() : dateTool2.getMinutes()) + ' : ' + unitTransform(params[2].data[1], dataObj.unit)
                    }
                    if (params[2].data == undefined) {
                        var dateTool = new Date(params[0].data[0]);
                        var dateTool1 = new Date(params[1].data[0]);
                        return params[0].seriesName + "<br/>" + (dateTool.getDate()) + '/' + (dateTool.getHours()) + ':' + (dateTool.getMinutes() < 10 ? '0' + dateTool.getMinutes() : dateTool.getMinutes()) + ' : ' + unitTransform(params[0].data[1], dataObj.unit) + '<br/>'
                            + params[1].seriesName + "<br/>" + (dateTool.getDate()) + '/' + (dateTool1.getHours()) + ':' + (dateTool1.getMinutes() < 10 ? '0' + dateTool1.getMinutes() : dateTool1.getMinutes()) + ' : ' + unitTransform(params[1].data[1], dataObj.unit)
                    }
                    if (params[0].data[0] && params[1].data[0]) {
                        ...
                        var dateTool2 = new Date(params[2].data[0]);
                        return params[0].seriesName + "<br/>" + (dateTool.getDate()) + '/' + (dateTool.getHours()) + ':' + (dateTool.getMinutes() < 10 ? '0' + dateTool.getMinutes() : dateTool.getMinutes()) + ' : ' + unitTransform(params[0].data[1], dataObj.unit) + '<br/>'
                            + params[1].seriesName + "<br/>" + (dateTool.getDate1()) + '/' + (dateTool1.getHours()) + ':' + (dateTool1.getMinutes() < 10 ? '0' + dateTool1.getMinutes() : dateTool1.getMinutes()) + ' : ' + unitTransform(params[1].data[1], dataObj.unit) + '<br/>'
                            + params[2].seriesName + "<br/>" + (dateTool.getDate2()) + '/' + (dateTool2.getHours()) + ':' + (dateTool2.getMinutes() < 10 ? '0' + dateTool2.getMinutes() : dateTool2.getMinutes()) + ' : ' + unitTransform(params[2].data[1], dataObj.unit);
                    }
        ...
        var option = {
            ...
            tooltip: {
                ...
                formatter: function (params) {
                    ...
                    if (params[0].data == undefined) {
                        var dateTool1 = new Date(params[1].data[0]);
                        return params[1].seriesName + "<br/>" + (dateTool1.getDate()) + '/' + (dateTool1.getHours()) + ':' + (dateTool1.getMinutes() < 10 ? '0' + dateTool1.getMinutes() : dateTool1.getMinutes()) + ' : ' + unitTransform(params[1].data[1], dataObj.unit)
                    }
                    if (params[0].data[0] && params[1].data[0]) {
                        var dateTool = new Date(params[0].data[0]);
                        var dateTool1 = new Date(params[1].data[0]);
                        return params[0].seriesName + "<br/>" + (dateTool.getDate()) + '/' + (dateTool.getHours()) + ':' + (dateTool.getMinutes() < 10 ? '0' + dateTool.getMinutes() : dateTool.getMinutes()) + ' : ' + unitTransform(params[0].data[1], dataObj.unit) + '<br/>'
                            + params[1].seriesName + "<br/>" + (dateTool1.getDate()) + '/' + (dateTool1.getHours()) + ':' + (dateTool1.getMinutes() < 10 ? '0' + dateTool1.getMinutes() : dateTool1.getMinutes()) + ' : ' + unitTransform(params[1].data[1], dataObj.unit);
                    }
        ...
        if (metricGroup) {
            ...
            for (key in dataMap) {
                ...
                if (valueInfo && valueInfo.length > 2) {
                    ...
                    var maxVTime = new Number(valueInfo[1]['collectTime']),
                        minVTime = new Number(valueInfo[1]['collectTime']);
                ...
                for (var x = 0; x < metricGroup.length; x++) {
                    ...
                    if (metricItemData) {
                        for (var dDouStrArr = 0; dDouStrArr < metricItemData.length; dDouStrArr++) {
                            ...
                            /*处理无数据时间节点显示 huangping 2017/6/30 start*/
                            if ("null" == metricItemDataObj['data']) {
                                switch (metricIdName) {
                                    case "ifOutBandWidthUtil":
                            ...
                            /*处理无数据时间节点显示 huangping 2017/6/30 end*/
                        }
                    }
...
function unitTransform(value, unit) {
    return oc.module.topo.unitTransform(value, unit);
}
