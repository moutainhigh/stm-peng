...
_4.oldValue="";
var _5=$("<input type=\"file\" class=\"textbox-value\" style=\"z-index:99999\">").appendTo(
		_3.filebox).css({opacity:0,left:-20});
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{buttonIcon:null,buttonText:"...",buttonAlign:"right"});
})(jQuery);
