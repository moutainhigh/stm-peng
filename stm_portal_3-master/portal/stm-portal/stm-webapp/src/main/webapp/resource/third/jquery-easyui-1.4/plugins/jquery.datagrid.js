...
(function($) {
	...
	function _8c(_8d, _8e) {
		...
		_97.find("div.datagrid-cell").removeClass(
		...
		function _9f() {
			...
			$.map(_a9, function(_aa) {
				...
				if (String(col.width || "").indexOf("%") >= 0) {
					var _ab = $.parser.parseValue("width", col.width, dc.view,
							_9d.scrollbarSize)
							- col.deltaWidth;
					if (_ab > 0) {
						col.boxWidth = _ab;
		...
		function _1c(_b3) {
			...
			function _b6(_b7) {
				...
				if (_b7 == "header") {
					...
					_b0.finder.getTr(_ad, 0, _b7).find(
							"td[field=\"" + _b3 + "\"] div.datagrid-cell")
							.each(function() {
								var w = _b9($(this));
								if (_b8 < w) {
									_b8 = w;
				...
				return _b8;
				function _b9(_ba) {
					return _ba.is(":visible") ? _ba._outerWidth() : tmp.html(
							_ba.html())._outerWidth();
				}
				;
			}
			;
	...
	function _104(_105, _106) {
		...
		opts.finder.getTr(_105, _107.highlightIndex).removeClass(
				"datagrid-row-over");
	...
	function _10e(_11e, _11f) {
		...
		opts.finder.getTr(_11e, "", "selected").removeClass(
	...
	function _116(_129, _12a, _12b) {
		...
		var tr = opts.finder.getTr(_129, _12a).removeClass(
	...
	function _11c(_12e, _12f) {
		...
		var bck = opts.finder.getTr(_12e, "", "allbody").addClass(
	...
	function _122(_131, _132) {
		...
		var dc = _133.dc;
		var hck = dc.header1.add(dc.header2).find("input[type=checkbox]");
		var bck = opts.finder.getTr(_131, "", "checked").removeClass(
				"datagrid-row-checked").find(
				"div.datagrid-cell-check input[type=checkbox]");
	...
	function _187(_188, _189) {
		...
		var tr = opts.finder.getTr(_188, (_189.index != undefined ? _189.index
				: _189.id), _189.type);
		if (!tr.length) {
			return;
		}
		...
		return this.each(function() {
			...
			if (_18e) {
				...
				opts = $.extend({}, $.extend({}, $.fn.datagrid.defaults, {
					queryParams : {}
				}), $.fn.datagrid.parseOptions(this), _18c);
			...
			return {
				...
				getValue : function(_199) {
					if (isA(_199, name)) {
						...
						if (opts.multiple) {
							return $(_199)[name]("getValues").join(
									opts.separator);
						} else {
	...
	var _19e = $
			.extend(
					{},
					_190([ "text", "textbox", "numberbox", "numberspinner",
	...
	$.fn.datagrid.parseOptions = function(_1e4) {
		...
		return $.extend({}, $.fn.panel.parseOptions(_1e4), $.parser
				.parseOptions(_1e4, [ "url", "toolbar", "idField", "sortName",
	...
	$.fn.datagrid.parseData = function(_1e5) {
		...
		var _1e6 = t.datagrid("getColumnFields", true).concat(
	...
	var _1e7 = {
		...
		onAfterRender : function(_220) {
			...
			if (opts.showFooter) {
				var _221 = $(_220).datagrid("getPanel").find(
						"div.datagrid-footer");
				_221
						.find(
