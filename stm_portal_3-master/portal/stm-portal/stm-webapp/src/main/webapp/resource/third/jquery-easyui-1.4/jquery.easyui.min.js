...
(function($) {
	function init(_1cd) {
		...
		$(_1cd)
				.html(
						"<div class=\"progressbar-text\"></div><div class=\"progressbar-value\"><div class=\"progressbar-text test_progressbar\"></div></div>");
...
(function($) {
	...
	function _290(_291, _292, _293) {
		...
		win.append(_292);
		win.children().eq(1).addClass('oc-notice');
		if (_293) {
		...
		progress : function(_29f) {
			var _2a0 = {
				...
				close : function() {
					...
					// 关闭进度条
					if ($.messager.progress.winObject) {
						$.messager.progress.winObject.window("close");
						$.messager.progress.winObject = undefined;
					}
				}
			};
			...
			win.parent().addClass("oc-loading-window");
			...
			// 储存进程条对象
			$.messager.progress.winObject = win;
			return win;
		}
	};
	$.messager.defaults = {
								...
								_2c7,
								{
									onBeforeExpand : function() {
										if (opts.onBeforeSelect) {
											if (opts.onBeforeSelect
													.call(_2c6, $(this).panel(
															"options").title,
															_2b9(_2c6, this)) == false) {
												return false;
											}
										}
										...
										if(opts.ocSelected){
											_2c8.addClass("oc-accordion-selected");
										}
									...
									onExpand : function() {
										...
										opts.onSelect.call(_2c6, $(this).panel(
												"options").title, _2b9(_2c6,
												this));
									},
									onBeforeCollapse : function() {
										if (opts.onBeforeUnSelect) {
										...
										if(opts.ocSelected){
											_2c9.removeClass("oc-accordion-selected");
										}
									...
									onCollapse : function() {
										...
										opts.onUnselect.call(_2c6, $(this)
												.panel("options").title, _2b9(
												_2c6, this));
									}
								}));
	...
	$.fn.tabs.methods = {
		...
		scrollBy : function(jq, _364) {
			return jq.each(function() {
				...
				// 显示隐藏左右按钮
				if(wrap._scrollLeft() + _364 <= 0){
					$(this).find(">div.tabs-header>div.tabs-scroller-left").hide();
				}else{
					$(this).find(">div.tabs-header>div.tabs-scroller-left").show();
				}
				if(wrap._scrollLeft() + _364 >= _365()){
					$(this).find(">div.tabs-header>div.tabs-scroller-right").hide();
				}else{
					$(this).find(">div.tabs-header>div.tabs-scroller-right").show();
...
(function($) {
	...
	function _436(_437) {
		...
		function _43a() {
			...
			if (opts.required) {
				var v=box.val();
				if (v == "" || v=='${oc.local.ui.select.placeholder}'.toI18n()) {
					box.addClass("validatebox-invalid");
...
(function($) {
	...
	function _45a(_474, _475) {
		...
		if (_475) {
			opts.disabled = true;
			$(_474).attr("readOnly",true);
			tb.find(".textbox-text,.textbox-value")
					.attr("readOnly",true);
		} else {
			opts.disabled = false;
			$(_474).removeAttr("readOnly");
			tb.find(".textbox-text,.textbox-value").removeAttr("readOnly");
		}
	}
	;
		...
		dc.body1.add(dc.body2).unbind().bind("mouseover", function(e) {
			...
			if (tt.parent().hasClass("datagrid-cell-check")) {
				...
				if (td.length) {
					...
					opts.onClickCell.call(_5ba, _5c7, _5c8, row[_5c8],e);
				}
...
//			dc.body2.css("overflow-x", "hidden");
	...
	function _5d8(_60f, data) {
		...
		if (!opts.remoteSort && opts.sortName) {
			...
			data.rows = data.rows.sort(function(r1, r2) {
				var r = 0;
	...
	function _698(_699) {
		...
		var data = _69a.data;
		var rows = data.rows;
		var _69b = [],len=rows?rows.length:0;
		for (var i = 0; i < len; i++) {
								...
								if (_753 == 0) {
									...
									if (type == "body") {
										...
										if (!tr.length) {
											tr = (_753 == 1 ? dc.body1
													: dc.body2)
													.find(">div>table>tbody>tr[datagrid-row-index="
															+ _752 + "]");
										}
										return tr;
									} else {
										if (type == "footer") {
											...
											if (type == "selected") {
												return (_753 == 1 ? dc.body1
														: dc.body2)
														.find(">div>table>tbody>tr.datagrid-row-selected");
											} else {
												if (type == "highlight") {
													return (_753 == 1 ? dc.body1
															: dc.body2)
															.find(">div>table>tbody>tr.datagrid-row-over");
												} else {
													if (type == "checked") {
														return (_753 == 1 ? dc.body1
																: dc.body2)
																.find(">div>table>tbody>tr.datagrid-row-checked");
													} else {
														if (type == "last") {
															return (_753 == 1 ? dc.body1
																	: dc.body2)
																	.find(">div>table>tbody>tr[datagrid-row-index]:last");
														} else {
															if (type == "allbody") {
																return (_753 == 1 ? dc.body1
																		: dc.body2)
