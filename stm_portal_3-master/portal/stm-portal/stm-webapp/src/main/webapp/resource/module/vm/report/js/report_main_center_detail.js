(function($){
	oc.ns('oc.vm.main.center.detail');
		...
		datagrid = oc.ui.datagrid({
			...
			columns:[[
		         ...
		         {field: 'op',title:'操作',width:100,align:'left',formatter:function(value,row,rowIndex){
		        	 if(row.removeAble){
		        		 return '<a name="'+rowIndex+'" title="excel下载!" class="ico ico-excel"></a><a name="'+rowIndex+'" title="word下载!" class="ico ico-word"></a><a name="'+rowIndex+'" title="pdf下载!" class="ico ico-pdf"></a><a name="'+rowIndex+'" title="删除!" class="ico ico-del"></a>';
		        	 }else{
		        		 return '<a name="'+rowIndex+'" title="excel下载!" class="ico ico-excel"></a><a name="'+rowIndex+'" title="word下载!" class="ico ico-word"></a><a name="'+rowIndex+'" title="pdf下载!" class="ico ico-pdf"></a>';
		        	 }
...
//		     },
		     ...
		     onLoadSuccess:function(data){
		    	 ...
		    	 //删除方法
		    	 reportMainCenterDiv.find('.ico-del').on('click',function(event){
		    		 event.stopPropagation();
		    		 var rowIndex = $(this).attr('name');
	        		 var row = rows[rowIndex];
		    		 if($(this).attr('class') == "ico ico-del"){
		    	 ...
		    	 reportMainCenterDiv.find('.ico').each(function(){
...
//		<a class="reportNameFilterQueryButton" >确定</a>
		...
		reportMainCenterDiv.find('.l-btn-text').on('click',function(){
			...
			reportMainCenterDiv.find('.reportNameFilter').val('');
			reportMainCenterDiv.find('.createUserFilter').val('');
			//隐藏域清除
