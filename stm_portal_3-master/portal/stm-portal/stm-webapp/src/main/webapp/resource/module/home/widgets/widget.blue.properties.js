(function(){
	...
	properties.focusMetric = {
		...
		plotLineChartOption : {
		    ...
		    color:['#19ffff','#19ff1f','#ffff56','#ff6e3c','#df00ff'],
		    grid: {
		        left: '3%',
		        right: '4%',
		        bottom: '3%',
    	...
    	plotFunnelChartOption : {
    		color:["#12B312","#14CD52","#16E7A1","#18FFFF","#E6F8FF"],
		    title: {
		        text: '漏斗图',
		        subtext: '',
		        show:false
		    ...
		    series: [
		        {
		            ...
		            axisLine: {
		                show: true,
		                lineStyle: {
		                    color: [[0.2, '#00cc00'],[0.8, '#ffff33'],[1, '#ff9100']],
		                    width: 6
		                }
		            },
		            axisTick: {
		...
		plotMetricCircleChartColor : ['#081629']
	...
	properties.statisticView = {
			//告警图
			warmingOption : {
				color:['#C30934','#FFFF39','#FF9100','#980D2E','#E5E615','#FF0039','#C7B521','#E68200','#B36C01'],
			    tooltip: {
			        trigger: 'item',
			        formatter: function(p){
			        	var val = p.name +'<br/>';
