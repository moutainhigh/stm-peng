(function(c) {
    ...
    function ga(z, s) {
        ...
        function ha(b) {
        	var div = c('<div style="position:absolute;"/>').appendTo(i).css({border:"solid 2px #ffffff"/*"background":"rgb("+Math.round(Math.random()*255)+","+Math.round(Math.random()*255)+","+Math.round(Math.random()*255)+")"*/})
			var bjd = div.append('<span class="light-ico greenlight"></span><br/>')
            var d = c('<img class="carousel-item"/>').appendTo(div);
            Z.push(d);
            d.css({
                ...
                h: a.settings.itemHeight,
                index: b,
                serviceId:j[b].serviceId
            }).data("path", j[b].path).addClass("out").bind({
                mouseover: function() {
                ...
                click: function() {
                	c.isFunction(a.settings.itemClick) && a.settings.itemClick.call(this, this,i.find(".click"));
        ...
        function N(b) {
            ...
            e = Z[b];
            c("<img/>").load(function() {
                var h = a.settings.self_width;//parseInt(c(this).attr("width") || c(this).prop("width")),
                f = a.settings.self_height;//parseInt(c(this).attr("height") || c(this).prop("height"));
        ...
        function o(b) {
            i.find(".carousel-item").each(function(d) {
                ...
                e.parent().css({
                    ...
                    top: D + f * (1 - r) / 2-a.settings.self_top,
				...
				e.parent().find(".rectDiv").css({
					width: h * r,
                    height: f * r
				})
				c.isFunction(a.settings.itemMove) && a.settings.itemMove.call(this,e,h*r,f*r);
            });
                ...
                i.children().each(function() {
                    ...
                    d = 0; d < c(this).children().length; d++) {
                        ...
                        if (c(e).is("a")) {
                        	...
                        	b.path = c(e).attr("src");
                        	b.serviceId = c(e).attr("serviceId");
                        }
    ...
    c.fn.carousel = function(z) {
        for (var s = [], m = 0; m < this.length; m++) if (!this[m].carousel) {
            ...
            this[m].carousel.Z[0] && this[m].carousel.Z[0].trigger("click");
