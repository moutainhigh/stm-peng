...
(function($) {
    ...
    $.fn.topoColorpicker = function(options) {
        var opts = jQuery.extend({}, jQuery.fn.topoColorpicker.defaults, options);
        initColor();
        ...
        function initColor(){
            ...
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00;width:70px;"></td>'
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;width:80px;" value="#000000"><span id="_cclose">关闭</span></td></tr></table></td></table>'
    ...
    jQuery.fn.topoColorpicker.defaults = {
