$(function() {
	...
	function init(type,cfg,container){
		...
		container.append('<div class="modelnavlist" style="float:right;"><a class="clicktheleft oc-btn-sidebg " style="float:left"><span class="oc-btnsetting"></span><a class="clicktheleft oc-btn-sidebg " style="float:right"><span class="oc-btnleft"></span></a></div>');
...
//			modelnavlist.append(netstatBtn);
		...
		container.find(".clicktheleft").click(function(){
			...
			//oc-btnleft
	        if(activenum%2==0){
	        	$(".oc-btnright").attr("class","oc-btnleft");
	        	...
	        	$(".oc-btnleft").attr("class","oc-btnright");
	            $(".modelnavlist").animate({
	                width:modelnavlistWidth + 'px',
	                left:"-7px"
	            },500);
	            activenum--;
	        }
