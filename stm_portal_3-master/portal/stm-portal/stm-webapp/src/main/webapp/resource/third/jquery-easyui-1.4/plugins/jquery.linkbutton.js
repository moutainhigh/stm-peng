...
(function($) {
	...
	function _9(_a) {
		...
		if (_b.selected) {
			t.addClass(_b.plain ? "l-btn-selected l-btn-plain-selected"
					: "l-btn-selected");
		}
	...
	function _d(_f, _10) {
		...
		if (_10) {
			...
			$(_f).addClass(
					_11.plain ? "l-btn-selected l-btn-plain-selected"
							: "l-btn-selected");
			_11.selected = true;
		} else {
			if (!_11.group) {
	...
	function _e(_12, _13) {
		...
		if (_13) {
			...
			_15.plain ? $(_12).addClass("l-btn-disabled l-btn-plain-disabled")
			...
			if (_19) {
				...
				$.data(this, "linkbutton", {
					options : $.extend({}, $.fn.linkbutton.defaults,
							$.fn.linkbutton.parseOptions(this), _17)
				});
