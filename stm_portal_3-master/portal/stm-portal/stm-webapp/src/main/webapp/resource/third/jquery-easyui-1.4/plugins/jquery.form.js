...
(function($) {
	function _1(_2, _3) {
		...
		var _7 = $("<iframe id=" + _6 + " name=" + _6 + "></iframe>").appendTo(
				"body");
		_7.attr("src", window.ActiveXObject ? "javascript:false"
				: "about:blank");
		_7.css({
			position : "absolute",
			top : -1000,
	...
	function _11(_12, _13) {
		...
		function _1b(_1f, val) {
			var rr = $(_12).find(
					"input[name=\"" + _1f + "\"][type=radio], input[name=\""
							+ _1f + "\"][type=checkbox]");
	...
	;
	function _25(_26) {
		$("input,select,textarea", _26).each(
				function() {
	...
	function _33(_3a, _3b) {
		...
		_3c.novalidate = _3b;
		$(_3a).find(".validatebox-text:not(:disabled)").validatebox(
				_3b ? "disableValidation" : "enableValidation");
	}
	;
