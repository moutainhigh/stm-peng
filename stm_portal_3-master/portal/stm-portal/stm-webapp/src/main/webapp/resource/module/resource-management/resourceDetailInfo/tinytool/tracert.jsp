...
function tracert(cmd,nodeGroupId) {
	if (cmd=='') return;
	...
	$.ajax({
		   type: "POST",
		   url: "../../../../../portal/resource/tinyTools/tracert.htm",
