...
//	var type = getType();
	 ...
	 * 初始化datagrid
	 */
	var datagridDiv=$('.ipgroup-tos-datagrid');
	datagridObj_netflow_ipgroup_tos=oc.ui.datagrid({
...
//    				var ti = timePerid;
    				...
    				genNetflowChart($('.ipgroup-tos-hc'), 660, 135, data.data.timeLine, data.data.bos, data.data.sortColumn, data.data.yAxisName, step, ti, st, et);
    			}
    		});
	     }
	});
