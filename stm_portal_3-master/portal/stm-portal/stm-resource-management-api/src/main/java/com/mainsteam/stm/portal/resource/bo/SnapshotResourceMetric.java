...
public class SnapshotResourceMetric implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof SnapshotResourceMetric)){
			return false;
		}
		
		SnapshotResourceMetric metric = (SnapshotResourceMetric)obj;
