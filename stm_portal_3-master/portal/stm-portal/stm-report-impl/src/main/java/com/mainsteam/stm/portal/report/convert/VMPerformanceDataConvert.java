...
public class VMPerformanceDataConvert extends BaseDataConvert{
	...
	public VMPerformanceDataConvert(ReportTemplate reportTemplate,ReportTemplateDirectory reportTemplateDirectory){
			...
			for(ReportTemplateDirectoryInstance instance:instanceList){
				...
				for(InstanceMetricSummeryReportData instanceDetailData:subList){
					...
					for(ReportTemplateDirectoryMetric metric: metricList){
						...
						if(data!=null){
							value.append(""+data.getAvg());
							value.append(SEPARATOR);
							value.append(""+data.getMax());
							value.append(SEPARATOR);
							value.append(""+data.getMin());
							value.append(SEPARATOR);
						}else{
							value.append("null");
							value.append(SEPARATOR);
