...
public class StatistResourceMetricBo implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof StatistResourceMetricBo)){
			return false;
		}
		
		StatistResourceMetricBo metric = (StatistResourceMetricBo)obj;
