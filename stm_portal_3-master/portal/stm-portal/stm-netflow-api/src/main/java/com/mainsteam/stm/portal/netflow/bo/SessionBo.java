...
public class SessionBo implements Serializable {
	...
	//包占比
	private String packets_rate;
	private String packetPctge;
	//连接数占比
	private String connects_rate;
	...
	/**
	 * @param flowPctge the flowPctge to set
	 */
	...
	/**
	 * @return the packets_rate
	 */
	public String getPackets_rate() {
		return packets_rate;
	}

	/**
	 * @param packets_rate the packets_rate to set
	 */
	public void setPackets_rate(String packets_rate) {
		this.packets_rate = packets_rate;
	}

	/**
	 * @return the connects_rate
	 */
	public String getConnects_rate() {
		return connects_rate;
	}

	/**
	 * @param connects_rate the connects_rate to set
	 */
	public void setConnects_rate(String connects_rate) {
		this.connects_rate = connects_rate;
	}
