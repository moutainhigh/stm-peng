...
public interface IIfAppApi {
	 ...
	 * NetflowPageBo    返回类型
	 */
	NetflowPageBo ifAppPageSelect(NetflowParamBo bo);
	
	/**
	 * 获取接口引用流量图表数据-highcharts
	 * 
	 * @param bo
	 * @return
	 * NetflowCharWrapper    返回类型
	 */
	NetflowCharWrapper getIfAppChartData(NetflowParamBo bo);
}
